...
function ClothesData ({weatherCodes, selectedSex}){
  const item = {disabled: false}
    if (selectedSex === 'female'){
      ...
      } else if (weatherCodes.temperature_2m >= 5 || weatherCodes.weather_code === 65){
        return (
        <ul className={styles.clothes}>
          <li style={{ opacity: item.disabled ? 0 : 1, 
    ...
    return(
      <ul className={styles.clothes}>
             <li style={{ opacity: item.disabled ? 0 : 1, 
                         ...
                         backgroundRepeat: 'no-repeat',
                         paddingLeft: '45px',
                         paddingTop: '10px'}}> Ботинки
            </li>
            <li style={{ opacity: item.disabled ? 0 : 1, 
                         backgroundImage: `url(${casuale_t_shirt})`, 
                         backgroundRepeat: 'no-repeat',
                         paddingLeft: '45px',
                         paddingTop: '10px'}}> Футболка
            </li>
            <li style={{ opacity: item.disabled ? 0 : 1, 
                         backgroundImage: `url(${baseball})`, 
                         backgroundRepeat: 'no-repeat',
